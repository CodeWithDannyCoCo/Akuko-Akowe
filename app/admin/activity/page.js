...
import { ArrowLeft, Users, FileText, MessageSquare, Search, Filter, Sun, Moon } from 'lucide-react'
        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    >
                        <option value="all" className="font-medium">All Activities</option>
                        <option value="users" className="font-medium">Users Only</option>
                        <option value="posts" className="font-medium">Posts Only</option>
                        <option value="comments" className="font-medium">Comments Only</option>
                    </select>
                </div>
            </div>
