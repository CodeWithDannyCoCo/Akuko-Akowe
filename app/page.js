        ...
        <div className="max-w-3xl mx-auto">
            ...
            {isAuthenticated && (
              <div className="flex w-full sm:w-auto space-x-2 sm:space-x-4">
                <button
                  ...
                  className={`flex-1 sm:flex-none px-3 sm:px-4 py-2 text-sm rounded transition-colors ${feedType === 'general'
                ...
                <button
                  ...
                  className={`flex-1 sm:flex-none px-3 sm:px-4 py-2 text-sm rounded transition-colors ${feedType === 'personalized'
                    ? 'bg-blue-500 text-white'
                    : 'bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700'
                    }`}
                >
          ...
          {loading ? (
            <div className="text-center py-8">
              <div className="animate-pulse text-gray-500 dark:text-gray-400">Loading posts...</div>
            </div>
          ) : posts.length === 0 ? (
