...
export default function Profile() {
    ...
    const renderAvatar = () => {
        ...
        if (avatarUrl) {
            return (
                <div className="relative w-24 h-24 sm:w-32 sm:h-32 rounded-full overflow-hidden ring-4 ring-white dark:ring-gray-700">
                    <Image
                        src={avatarUrl}
        ...
        return (
            <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-full bg-gradient-to-br from-blue-100 to-blue-50 dark:from-blue-900 dark:to-blue-800 flex items-center justify-center ring-4 ring-white dark:ring-gray-700">
                <span className="text-4xl sm:text-5xl font-medium text-blue-500 dark:text-blue-300">
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 sm:p-8 mb-8">
                            <div className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left">
                                ...
                                <div className="mt-4 sm:mt-0 sm:ml-8">
                                    ...
                                    <div className="mt-4 inline-flex items-center text-sm text-gray-500 dark:text-gray-400">
                                        <span>Joined {new Date(user.date_joined).toLocaleDateString(undefined, {
                                            year: 'numeric',
                                            month: 'short',
                                            day: 'numeric'
                                        })}</span>
                            ...
                            <div className="mt-8 grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 border-t border-gray-100 dark:border-gray-700 pt-8">
                                ...
                                <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 text-center">
                                    ...
                                    <div className="text-sm font-medium text-gray-500 dark:text-gray-400">Likes</div>
                                </div>
                                <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 text-center">
                                    <div className="text-2xl font-bold text-gray-900 dark:text-white">
                                ...
                                <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 text-center">
                                    ...
                                    <div className="text-sm font-medium text-gray-500 dark:text-gray-400">Bookmarks</div>
                                </div>
                            </div>
                        </div>
