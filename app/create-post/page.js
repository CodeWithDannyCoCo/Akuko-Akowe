    ...
    <div>
      ...
      <main className="container mx-auto px-4">
        ...
        <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md max-w-2xl mx-auto">
          <div className="mb-4">
            <label htmlFor="title" className="block text-gray-700 dark:text-gray-200 font-bold mb-2">Title</label>
            <input
              type="text"
              id="title"
              value={title}
          ...
          <div className="mb-4">
            <label htmlFor="content" className="block text-gray-700 dark:text-gray-200 font-bold mb-2">Content</label>
            <textarea
              id="content"
              value={content}
          ...
          <div className="mb-6">
            <label htmlFor="tags" className="block text-gray-700 dark:text-gray-200 font-bold mb-2">Tags (comma-separated)</label>
            <input
              type="text"
              id="tags"
              value={tags}
