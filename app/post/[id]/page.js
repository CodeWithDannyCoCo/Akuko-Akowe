...
import { CommentSection, LikeBookmarkButtons } from "../../../components/posts";
...
export default function PostDetail({ params }) {
  ...
  const renderAuthorAvatar = () => {
    const avatarUrl = post.author?.avatar
      ? api.getFullAvatarUrl(post.author.avatar)
      : null;
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-4 sm:py-8">
          <div
            role="alert"
            className="p-4 sm:p-6 bg-red-100 text-red-700 rounded-lg"
          >
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-4 sm:py-8">
        ...
        <article className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700">
          <div className="p-4 sm:p-6">
            ...
            <div
              className="prose dark:prose-invert max-w-none text-sm sm:text-base text-gray-900 dark:text-gray-100"
