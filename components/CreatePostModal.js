...
export default function CreatePostModal({ isOpen, onClose, onPostCreated }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div ref={modalRef} className="bg-white dark:bg-gray-800 rounded-lg w-full max-w-md p-6 relative">
        <button
          onClick={onClose}
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <label htmlFor="tags" className="block text-gray-700 dark:text-gray-300 font-semibold text-sm mb-2">Tags (comma-separated)</label>
            <input
              type="text"
              id="tags"
              value={tags}
          ...
          <button
            type="submit"
            className={`w-full px-4 py-2 rounded transition-colors ${isSubmitting
